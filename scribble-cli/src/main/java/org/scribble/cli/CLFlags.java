...
public class CLFlags {
    ...
    public static final String SCRIBBLE_SINGLE_BUFFERS = "-scrib-buff-1";  // Default
    public static final String SCRIBBLE_UNBOUNDED_BUFFERS = "-scrib-buff-w";
    ...
    public static final String DOT_FLAG = "-dot";  // Default
    ...
    protected Map<String, CLFlag> getFlags() {
        ...
        /*flags.put(NO_VALIDATION_FLAG,
                new CLFlag(NO_VALIDATION_FLAG, 0, true, false, false,
                        "Duplicate flag: "));*/
        flags.put(SCRIBBLE_SINGLE_BUFFERS,
                new CLFlag(SCRIBBLE_SINGLE_BUFFERS, 0, true, false, false,
                        "Duplicate flag: ", CLFlags.SCRIBBLE_UNBOUNDED_BUFFERS));
        flags.put(SCRIBBLE_UNBOUNDED_BUFFERS,
                new CLFlag(SCRIBBLE_UNBOUNDED_BUFFERS, 0, true, false, false,
                        "Duplicate flag: ", CLFlags.SCRIBBLE_SINGLE_BUFFERS));
