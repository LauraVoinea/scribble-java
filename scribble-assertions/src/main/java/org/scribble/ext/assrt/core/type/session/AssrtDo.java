...
public abstract class AssrtDo<K extends ProtoKind, B extends AssrtSType<K, B>>
		extends AssrtSTypeBase<K, B>
{
	...
	public AssrtDo(CommonTree source, ProtoName<K> proto, List<Role> roles,
	...
	public abstract AssrtProtocol<K, ?, ?> getTarget(Core core);  // CHECKME: "?"
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof AssrtDo))
		{
			return false;
		}
		AssrtDo<?, ?> them = (AssrtDo<?, ?>) o;
