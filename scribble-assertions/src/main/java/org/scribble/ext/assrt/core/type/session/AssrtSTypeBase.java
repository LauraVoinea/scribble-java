...
public abstract class AssrtSTypeBase<K extends ProtoKind, 
			B extends AssrtSType<K, B>>
		extends STypeBase<K, NoSeq<K>> implements AssrtSType<K, B>
{
	public AssrtSTypeBase(CommonTree source)
	{
		super(source);
	}
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof AssrtSTypeBase))
		{
			return false;
		}
