...
public class AssrtSStateErrors extends SStateErrors
{
	...
	// TODO: could also check for roles stuck on unconnected sends here (probably better, than current syntax check)

	public final Map<Role, Set<AssrtEAction>> unknown;
	public final Map<Role, EState> assprog;  // TODO: rename -- state (safety) error, not "progress"
	public final Map<Role, Set<AssrtEAction>> assunsat;  // Cf. AssrtCoreSModel.getSafetyErrors, "manual" batching
	...
	public AssrtSStateErrors(AssrtCore core, GProtoName fullname,
			AssrtSState init, AssrtSState curr)
	{
		super(curr);
		AssrtSConfig cfg = (AssrtSConfig) curr.config;
		core.verbosePrintln(
	...
	protected AssrtSStateErrors(AssrtSStateErrors old,
			Map<Role, Set<AssrtEAction>> assunsat)
	{
