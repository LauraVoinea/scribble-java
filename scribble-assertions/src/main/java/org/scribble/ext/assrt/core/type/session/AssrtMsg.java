...
public class AssrtMsg
{
	...
	public AssrtMsg(Op op, List<AssrtAnnotDataName> pay, AssrtBFormula ass,
	...
	public AssrtMsg disamb(Map<AssrtVar, DataName> env)
	{
		return new AssrtMsg(this.op, this.pay,  // CHECKME: disamb payvars unnecessary?
	...
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof AssrtMsg))
		{
			return false;
		}
		AssrtMsg them = (AssrtMsg) obj;
