...
import org.scribble.ext.assrt.core.visit.AssrtSTypeInliner;

public class AssrtGTypeInliner extends AssrtSTypeInliner<Global, AssrtGType>
{
	public AssrtGTypeInliner(Core core)
	{
		super(core);
	}
