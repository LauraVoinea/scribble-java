...
public abstract class AssrtSTypeInliner<K extends ProtoKind, 
			B extends AssrtSType<K, B>>
		extends STypeInliner<K, NoSeq<K>>
{

	public AssrtSTypeInliner(Core core)
	{
		super(core);
	}
	
	@Override
	public AssrtSType<K, B> visitContinue(Continue<K, NoSeq<K>> n)
	{
		throw new RuntimeException("Deprecated for " + getClass() + ":\n" + n);
	}

	@Override
	public AssrtSType<K, B> visitChoice(Choice<K, NoSeq<K>> n)
	{
		throw new RuntimeException("Deprecated for " + getClass() + ":\n" + n);
	}

	@Override
	public AssrtSType<K, B> visitDirectedInteraction(
	...
	@Override
	public AssrtSType<K, B> visitDisconnect(DisconnectAction<K, NoSeq<K>> n)
	{
		throw new RuntimeException("Deprecated for " + getClass() + ":\n" + n);
	}

	@Override
	public AssrtSType<K, B> visitDo(Do<K, NoSeq<K>> n)
	{
		throw new RuntimeException("Deprecated for " + getClass() + ":\n" + n);
	}

	@Override
	public AssrtSType<K, B> visitRecursion(Recursion<K, NoSeq<K>> n)
	{
		throw new RuntimeException("Deprecated for " + getClass() + ":\n" + n);
	}
