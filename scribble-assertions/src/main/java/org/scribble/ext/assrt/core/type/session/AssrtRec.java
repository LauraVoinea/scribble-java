...
public abstract class AssrtRec<K extends ProtoKind, B extends AssrtSType<K, B>>  // Without Seq complication, take kinded Type directly
		extends AssrtSTypeBase<K, B>
{
	...
	public boolean equals(Object o)
	{
		...
		if (!(o instanceof AssrtRec))
		{
			return false;
		}
		AssrtRec<?, ?> them = (AssrtRec<?, ?>) o;
