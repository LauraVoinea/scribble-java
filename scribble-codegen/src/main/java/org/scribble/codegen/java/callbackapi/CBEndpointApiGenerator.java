...
public class CBEndpointApiGenerator {
    ...
    public Map<String, String> buildEndpointClass() throws ScribException {
        ...
        EState init = (this.core.config.hasFlag(CoreArgs.MIN_EFSM)
        ...
        for (EState s : states) {
            ...
            switch (kind) {
                case OUTPUT:
                    stateKind = "org.scribble.runtime.handlers.states.ScribOutputState";
                    break;
                case UNARY_RECEIVE:
                case POLY_RECIEVE:
                    stateKind = "org.scribble.runtime.handlers.states.ScribInputState";
                    break;
                case TERMINAL:
                    stateKind = "org.scribble.runtime.handlers.states.ScribEndState";
                    break;
                case ACCEPT:
                case SERVER_WRAP:
