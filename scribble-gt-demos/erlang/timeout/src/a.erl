...
-spec s5(internal | cast, {atom()} | {pid(), {atom(), term()}}, state_data()) -> {next_state, s6, state_data()} | {stop, normal, state_data()}.
...
-spec s6(cast, {pid(), {atom(), term()}}, state_data()) -> {next_state, s7, state_data()} | {stop, normal, state_data()}.
